...
export default function Edit({ auth, rule, variabelPelanggaran, variabelApresiasi, variabelKonselor, variabelDiagnosis }) {
    const [selectedPremise, setSelectedPremise] = useState(rule.premise || []);
    ...
    // Sync selectedPremise with data.premise
    useEffect(() => {
        setData('premise', selectedPremise);
    }, [selectedPremise]);
    ...
    return (
        <AppLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800">Edit Rule Expert System</h2>}
        >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end gap-3 pt-4 border-t">
                                ...
                                <PrimaryButton disabled={processing}>
                                    {processing ? 'Memperbarui...' : 'Perbarui Rule'}
                                </PrimaryButton>
                            </div>
                        </form>
